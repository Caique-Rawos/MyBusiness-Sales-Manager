import { StatusPagamentoTypeOrmRepository } from './status_pagamento.repository';

describe('StatusPagamentoTypeOrmRepository', () => {
  let typeOrmRepository: any;
  let repository: StatusPagamentoTypeOrmRepository;
