...
export class Initial1783307998184 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "contas_receber" ("id" SERIAL NOT NULL, "descricao" character varying(150) NOT NULL, "valorTotal" numeric(13,2) NOT NULL, "valorPago" numeric(13,2) DEFAULT '0', "dataVencimento" TIMESTAMP DEFAULT now(), "id_pagamento" integer, "id_status_pagamento" integer, "id_venda" integer, CONSTRAINT "REL_d19878115f9838b45831fc11a6" UNIQUE ("id_venda"), CONSTRAINT "PK_5837d45d5a8b6904175f1e0f56f" PRIMARY KEY ("id"))`);
