...
- [PENDÊNCIA: tela de gestão de usuários](project_pending_user_management_ui.md) — Falta UI+endpoints pra cadastrar novos e-mails/papéis por tenant; owner usa flag `isOwner` (bypass de permissão), não papel "Administrador" sincronizado
