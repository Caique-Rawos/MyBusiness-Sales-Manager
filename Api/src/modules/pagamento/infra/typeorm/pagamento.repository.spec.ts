import { PagamentoTypeOrmRepository } from './pagamento.repository';

describe('PagamentoTypeOrmRepository', () => {
  let typeOrmRepository: any;
  let repository: PagamentoTypeOrmRepository;
  ...
  beforeEach(() => {
    ...
    repository = new PagamentoTypeOrmRepository(typeOrmRepository as any);
  });
