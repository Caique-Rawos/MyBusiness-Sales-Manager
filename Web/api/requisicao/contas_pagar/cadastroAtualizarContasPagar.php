...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $descricao = isset($_POST["descricao"]) ? $_POST['descricao'] : msgHttpCode(400, 'Descrição não pode estar vazio');
    ...
    $dataVencimento = isset($_POST["dataVencimento"]) ? $_POST["dataVencimento"] : msgHttpCode(400, 'Data Vencimento não pode estar vazia');
    ...
    $data = array(
      ...
      if ($httpcode == 201) {
        ...
        msgHttpCode($httpcode, "Erro ao inserir Conta a Pagar: " . $response);
      }
